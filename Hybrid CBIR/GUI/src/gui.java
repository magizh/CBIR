...
public class gui extends javax.swing.JFrame {
   ...
   ImageIO.write(bdest,"JPG",new File(fileName));
        ...
        m.masfun(fileName);
        imgLabel1.setIcon(new ImageIcon(m.filename[m.fin[0]]));
        imgLabel2.setIcon(new ImageIcon(m.filename[m.fin[1]]));
        imgLabel3.setIcon(new ImageIcon(m.filename[m.fin[2]]));
        imgLabel4.setIcon(new ImageIcon(m.filename[m.fin[3]]));
        imgLabel5.setIcon(new ImageIcon(m.filename[m.fin[4]]));
        imgLabel6.setIcon(new ImageIcon(m.filename[m.fin[5]]));
        imgLabel7.setIcon(new ImageIcon(m.filename[m.fin[6]]));
        imgLabel8.setIcon(new ImageIcon(m.filename[m.fin[7]]));
        imgLabel9.setIcon(new ImageIcon(m.filename[m.fin[8]]));
        imgLabel10.setIcon(new ImageIcon(m.filename[m.fin[9]]));
   ...
   */
     //  m = new master(fileName);
        ...
        m.masfun(fileName);
        System.out.println("fin="+m.fin[0]);
          int f5=1;
          int in=0;
                  int y1=c;
                  int u=c;
